...
//
// build.rs — generates the **server-side** MIDL stub for mxc_service.idl
// and links rpcrt4. Intentionally a separate crate from the client to
// avoid cargo's feature unification linking conflicting `RpcCall`
// symbols into the same binary.
...
fn main() {
    ...
    cc::Build::new()
        ...
        .compile("mxc_service_rpc_server_stubs");
